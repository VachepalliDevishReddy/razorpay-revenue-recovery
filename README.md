...
1. **Ingestion**: Transaction failure payload received (mocked via `mock_data.json`).
...
3. **Razorpay Action**: For recoverable errors, a Razorpay Payment Link (`short_url`) is generated via the Python SDK.
